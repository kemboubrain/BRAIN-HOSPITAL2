/*
  # Insertion des données d'exemple avec prix en XOF

  1. Données d'exemple
    - Patients avec profils variés
  ...
  2. Prix en XOF (Franc CFA)
    - Consultations: 25,000 - 50,000 XOF
    - Médicaments: 100 - 5,000 XOF
    - Examens: 15,000 - 75,000 XOF
*/
...
INSERT INTO prescriptions (consultation_id, medication_id, dosage, frequency, duration, instructions) VALUES
('990e8400-e29b-41d4-a716-446655440001', '770e8400-e29b-41d4-a716-446655440001', '1 comprimé', '3 fois par jour', '5 jours', 'À prendre pendant les repas'),
('990e8400-e29b-41d4-a716-446655440002', '770e8400-e29b-41d4-a716-446655440001', '1 comprimé', 'Au besoin', '10 jours', 'Maximum 3 comprimés par jour'),
('990e8400-e29b-41d4-a716-446655440003', '770e8400-e29b-41d4-a716-446655440002', '1 gélule', '2 fois par jour', '7 jours', 'À prendre à jeun'),
('990e8400-e29b-41d4-a716-446655440003', '770e8400-e29b-41d4-a716-446655440009', '1 comprimé', '1 fois par jour', '15 jours', 'Le matin au petit-déjeuner');
...
('aa0e8400-e29b-41d4-a716-446655440001', 'Consultation pédiatrique', 1, 30000, 30000),
('aa0e8400-e29b-41d4-a716-446655440002', 'Consultation médecine générale', 1, 25000, 25000),
('aa0e8400-e29b-41d4-a716-446655440003', 'Consultation médecine générale', 1, 25000, 25000);
